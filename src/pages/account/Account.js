  ...
  return (
   ...
   <input type="checkbox" id="account-toggle" hidden />  
    ...
    <label for="account-toggle" class="account-toggle-open">
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 16h18v2H3zm0-5h18v2H3zm0-5h18v2H3z" fill-rule="evenodd"/></svg>
            </label>
      ...
      <div className="password-content content">
        ...
        <p>
          Please use letters, numbers and accepted symbols only, with no spaces,
          minimum 6, maximum 32 characters.
        </p>
        <p>
          Your password should not contain your username, name, email address or
          year of birth. You can increase the strength of your password by using a
          mixture of letters, numbers and symbols. Please remember that passwords
          are case-sensitive.
        </p>
      ...
      <div className="verification-content content">
        ...
        <p>
          If you have one, please submit a document that displays your residential
          address as registered on your bet365 account as this may save you time
          in the future.
        </p>
        <details>
          ...
          <div className="details-identity-content">
            <p>
              Upload a copy or take a photo of your identity document by selecting
