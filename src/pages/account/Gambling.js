  ...
  <div className="right-content">
    <div className="my-activity-content content">
      ...
      <div className="my-activity-tabs">
        ...
        <label htmlFor="months-12" className="months-12-tab my-activity-tab">
          12 Months
        </label>
      </div>
      <p>
        The figures displayed here include transactions made up to midnight on
        02/12/2024 GMT+6, with the exception of Deposit Limit data which is
        real-time.
      </p>
    ...
    <div className="deposit-limits-content content">
      ...
      <p>
        This facility enables you to limit the amount of money that you are able
        to deposit online into your account on either a 24 hour, 7 day and/or 30
        day basis.
      </p>
      <p>
        These amounts may be revised downwards at any time but any increase will
        only be implemented 24 hours after the request. Our Customer Services
        staff will be available to provide any further information required but
        are unable to override limits set by you.
      </p>
    ...
    <div className="time-out-content content">
      ...
      <div className="timeout-create-tab-content timeout-content-tab">
        <p>
          If you want to take a short break from playing with us, you may do so
          by taking a Time-Out for a specified period of time.
        </p>
        <p>
    ...
    <div className="self-exclusion-content content">
      ...
      <div className="self-exclusion-tab-content timeout-content-tab">
        ...
        <p>
          Please note that the Sports and Poker products may be self-excluded
          independently. However, should you wish to self-exclude from the
          Casino/Live Casino or the Games/Bingo products, this will result in
          the self-exclusion of the Casino/Live Casino, Games/Bingo and Poker
    ...
    <div className="account-closure-content content">
      ...
      <div className="account-closure-tab-content timeout-content-tab">
        ...
        <p>
          ...
          funds or play in any of our products. Should you wish to re-open your
          account during this period, you will be required to answer additional
          security questions to safeguard your account.
        </p>
        <p>
          Please note that verification of your account is still outstanding.
          Until we have successfully verified your account, it will not be
          possible to withdraw any remaining balance you may have. You can
          verify your account by visiting the
        </p>
        <p>
    ...
    <div className="reality-checks-content content">
      ...
      <div className="reality-checks-tab-content">
        <p>
          To support you in managing the amount of time you spend playing, you
          can set up a Reality Check on your account. Once this is set, a pop-up
          alert will be displayed as a reminder that you have been logged into
          your account for the specified period of time (excludes poker game
          play).
        </p>
        <p>
          The Reality Check timer starts when you log in. If you make any
          changes to this, the new setting will only take effect the next time
          you log in.
        </p>
        <p>
        ...
        <p>
          ...
          logged in, view your account history or log out of your account. If
          you choose to remain logged in then you will receive another alert
          after the same length of time so that you can keep track of your total
          time spent playing.
        </p>
