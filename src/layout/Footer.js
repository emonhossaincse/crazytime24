...
<div className="sckkbci helpus-wrap">
  <div className="helpus-inner">
    <div className="help-us-infos">
      ...
      <textarea placeholder="Found a bug or have any recommendations? Please leave your message here" name="" id="" cols="30" rows="10"></textarea>
...
<div className="page-max-width-wrap footer-infos">
  <div className="f1mx1119 footer-links-wrap">
    <div className="footer-link-wrap">
      ...
      <div className="links">
        <a href="#" keep-scroll-position="true" className="footer-link-item" title="Casino Home" target="_self">
          <span>Casino Home</span></a>
          <a href="#" keep-scroll-position="true" className="footer-link-item" title="Slots" target="_self">
            <span>Slots</span></a>
            <a href="#" keep-scroll-position="true" className="footer-link-item" title="Live Casino" target="_self">
              <span>Live Casino</span>
            </a><a href="#" keep-scroll-position="true" className="footer-link-item" title="New Releases" target="_self">
              <span>New Releases</span>
            </a>
            <a href="#" keep-scroll-position="true" className="footer-link-item" title="Recommended" target="_self">
              <span>Recommended</span>
            </a><a href="#" keep-scroll-position="true" className="footer-link-item" title="Table Game" target="_self">
              <span>Table Game</span></a><a href="#" keep-scroll-position="true" className="footer-link-item" title="BlackJack" target="_self">
                <span>BlackJack</span>
              </a>
              <a href="#" keep-scroll-position="true" className="footer-link-item" title="Roulette" target="_self">
                <span>Roulette</span>
              </a><a href="/tagname/baccarat" keep-scroll-position="true" className="footer-link-item" title="Baccarat" target="_self">
                  <span>Baccarat</span>
                </a>
              </div>
            </div>
            <div className="footer-link-wrap">
              ...
              <div className="links">
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Sports Home" target="_self">
                <span>Sports Home</span></a><a href="/sports?bt-path=%2Flive" keep-scroll-position="true" className="footer-link-item" title="Live" target="_self">
                  <span>Live</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Rules" target="_self">
                    <span>Rules</span>
                  </a>
                  <a href="#" keep-scroll-position="true" className="footer-link-item" title="Sport Betting Insights" target="_blank">
                    <span>Sport Betting Insights</span>
                    <svg className="hashbet" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
              ...
              <div className="footer-link-wrap">
                ...
                <div className="links">
                  <a href="#" keep-scroll-position="true" className="footer-link-item" title="VIP Club" target="_self">
                    <span>VIP Club</span>
                  </a>
                  <a href="#" keep-scroll-position="true" className="footer-link-item" title="Affiliate" target="_self">
                    <span>Affiliate</span>
                  </a>
                  <a href="#" keep-scroll-position="true" className="footer-link-item" title="Promotions" target="_self">
                    <span>Promotions</span>
                  </a>
                  <a href="#" keep-scroll-position="true" className="footer-link-item" title="Lottery" target="_self">
                    <span>Lottery</span>
                  </a>
                  <a href="#" keep-scroll-position="true" className="footer-link-item" title="Refer a friend" target="_self">
              ...
              <div className="footer-link-wrap">
                ...
                <div className="links">
                  <a href="#" keep-scroll-position="true" className="footer-link-item" title="Help center" target="_self">
                  <span>Help center</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Gamble Aware" target="_self">
                  <span>Gamble Aware</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Fairness" target="_self">
                  <span>Fairness</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="FAQ" target="_self">
                  <span>FAQ</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Privacy Policy" target="_self">
                  <span>Privacy Policy</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Terms Of Service" target="_self">
                  <span>Terms Of Service</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Self-exclusion" target="_self">
                  <span>Self-exclusion</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="AML" target="_self">
                  <span>AML</span>
                </a>
                <a href="#" keep-scroll-position="true" className="footer-link-item" title="Design Resources" target="_blank">
                  <span>Design Resources</span>
                  <svg className="hashbet" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                    <path d="M365.386 83.556c31.44 0 56.926 25.486 56.926 56.926 0 30.897-24.617 56.046-55.307 56.904l-1.62 0.022h-170.777v629.186h629.186v-170.777c0-30.897 24.617-56.046 55.307-56.904l1.62-0.022c30.897 0 56.045 24.617 56.904 55.307l0.022 1.62v179.768c0 57.258-45.887 103.796-102.894 104.848l-1.968 0.017h-647.16c-57.258 0-103.796-45.887-104.848-102.894l-0.017-1.968v-647.16c0-57.258 45.887-103.796 102.894-104.848l1.968-0.017h179.768zM611.108 84.556l1.62 0.013 227.481 4.701c57.907 1.009 104.028 48.774 103.019 106.677l-1.176 62.495-1.198 54.931-1.442 62.539-0.437 21.864c-0.034 1.776-0.066 3.547-0.094 5.315-0.549 31.434-26.475 56.472-57.909 55.926s-56.472-26.475-55.926-57.909l0.308-16.334 2.11-93 0.246-11.744-360.933 330.867c-23.176 21.246-59.187 19.678-80.428-3.495-20.849-22.748-19.728-57.854 2.233-79.234l1.267-1.193 355.396-325.787-134.861-2.783c-30.889-0.638-55.524-25.77-55.748-56.469l0.013-1.62c0.638-30.889 25.77-55.524 56.469-55.748z"></path></svg></a><a href="/app_download/android" keep-scroll-position="true" className="footer-link-item" title="APP" target="_self">
                      <span>APP</span>
                    </a>
                ...
                <div className="footer-link-wrap">
                  ...
                  <div className="links">
                    <a href="#" keep-scroll-position="true" className="footer-link-item" title="News" target="_blank">
                    <span>News</span>
                    <svg className="hashbet" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                      <path d="M365.386 83.556c31.44 0 56.926 25.486 56.926 56.926 0 30.897-24.617 56.046-55.307 56.904l-1.62 0.022h-170.777v629.186h629.186v-170.777c0-30.897 24.617-56.046 55.307-56.904l1.62-0.022c30.897 0 56.045 24.617 56.904 55.307l0.022 1.62v179.768c0 57.258-45.887 103.796-102.894 104.848l-1.968 0.017h-647.16c-57.258 0-103.796-45.887-104.848-102.894l-0.017-1.968v-647.16c0-57.258 45.887-103.796 102.894-104.848l1.968-0.017h179.768zM611.108 84.556l1.62 0.013 227.481 4.701c57.907 1.009 104.028 48.774 103.019 106.677l-1.176 62.495-1.198 54.931-1.442 62.539-0.437 21.864c-0.034 1.776-0.066 3.547-0.094 5.315-0.549 31.434-26.475 56.472-57.909 55.926s-56.472-26.475-55.926-57.909l0.308-16.334 2.11-93 0.246-11.744-360.933 330.867c-23.176 21.246-59.187 19.678-80.428-3.495-20.849-22.748-19.728-57.854 2.233-79.234l1.267-1.193 355.396-325.787-134.861-2.783c-30.889-0.638-55.524-25.77-55.748-56.469l0.013-1.62c0.638-30.889 25.77-55.524 56.469-55.748z"></path></svg>
                    </a><a href="#" keep-scroll-position="true" className="footer-link-item" title="Work with us" target="_blank">
                    ...
                    <button className="footer-link-item">Business Contacts</button>
                    <a href="#" keep-scroll-position="true" className="footer-link-item" title="Help Desk" target="_blank">
                      <span>Help Desk</span>
                      <svg className="hashbet" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                        <path d="M365.386 83.556c31.44 0 56.926 25.486 56.926 56.926 0 30.897-24.617 56.046-55.307 56.904l-1.62 0.022h-170.777v629.186h629.186v-170.777c0-30.897 24.617-56.046 55.307-56.904l1.62-0.022c30.897 0 56.045 24.617 56.904 55.307l0.022 1.62v179.768c0 57.258-45.887 103.796-102.894 104.848l-1.968 0.017h-647.16c-57.258 0-103.796-45.887-104.848-102.894l-0.017-1.968v-647.16c0-57.258 45.887-103.796 102.894-104.848l1.968-0.017h179.768zM611.108 84.556l1.62 0.013 227.481 4.701c57.907 1.009 104.028 48.774 103.019 106.677l-1.176 62.495-1.198 54.931-1.442 62.539-0.437 21.864c-0.034 1.776-0.066 3.547-0.094 5.315-0.549 31.434-26.475 56.472-57.909 55.926s-56.472-26.475-55.926-57.909l0.308-16.334 2.11-93 0.246-11.744-360.933 330.867c-23.176 21.246-59.187 19.678-80.428-3.495-20.849-22.748-19.728-57.854 2.233-79.234l1.267-1.193 355.396-325.787-134.861-2.783c-30.889-0.638-55.524-25.77-55.748-56.469l0.013-1.62c0.638-30.889 25.77-55.524 56.469-55.748z">
                    ...
                    <a href="#" keep-scroll-position="true" className="footer-link-item" title="Hashbet" target="_blank">
                      <span>Hashbet</span>
                      <svg className="hashbet" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                        <path d="M365.386 83.556c31.44 0 56.926 25.486 56.926 56.926 0 30.897-24.617 56.046-55.307 56.904l-1.62 0.022h-170.777v629.186h629.186v-170.777c0-30.897 24.617-56.046 55.307-56.904l1.62-0.022c30.897 0 56.045 24.617 56.904 55.307l0.022 1.62v179.768c0 57.258-45.887 103.796-102.894 104.848l-1.968 0.017h-647.16c-57.258 0-103.796-45.887-104.848-102.894l-0.017-1.968v-647.16c0-57.258 45.887-103.796 102.894-104.848l1.968-0.017h179.768zM611.108 84.556l1.62 0.013 227.481 4.701c57.907 1.009 104.028 48.774 103.019 106.677l-1.176 62.495-1.198 54.931-1.442 62.539-0.437 21.864c-0.034 1.776-0.066 3.547-0.094 5.315-0.549 31.434-26.475 56.472-57.909 55.926s-56.472-26.475-55.926-57.909l0.308-16.334 2.11-93 0.246-11.744-360.933 330.867c-23.176 21.246-59.187 19.678-80.428-3.495-20.849-22.748-19.728-57.854 2.233-79.234l1.267-1.193 355.396-325.787-134.861-2.783c-30.889-0.638-55.524-25.77-55.748-56.469l0.013-1.62c0.638-30.889 25.77-55.524 56.469-55.748z">
                ...
                <div className="footer-link-wrap">
                  ...
                  <div className="social-links">
                    <a className="telegram" href="#" target="_blank" rel="noopener noreferrer">
                    ...
                    <a className="discord" href="#" target="_blank" rel="noopener noreferrer">
                      <img src="/assets/share_2.45a347d3.png" alt="discord"/>
                    </a>
                    <a className="bitcoin" href="#" target="_blank" rel="noopener noreferrer">
              ...
              <div className="f19tyczm footer-gaming-wrap">
                ...
                <div className="wrap-two">
                  <div className="eighteen">
                    <a href="@" keep-scroll-position="true" rel="noopener noreferrer" className="">
                      <img alt="eighteen" src="/assets/eighteen_w.6097ab4b.png"/>
                    </a>
                  </div>
                </div>
              </div>
