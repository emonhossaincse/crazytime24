...
//   errors
  ...
  const handleCreatePlayer = async () => {
    try {
      ...
      const response = await fetch('https://joy88.xyz/api/v1/create-player', {
        method: 'POST',
        headers: {
        ...
        <div className="s1bscfa1">
                      <div className="ithbrou">
                          <div className="login-left">
                              ...
                              <img alt="" src="/assets/bg-c80415f6.png" className="common-left-img dark-mode"/>
                          ...
                          <div id="regist" className="simple-page s15zywit" style={{ opacity: 1, transform: 'none' }}>
                                  ...
                                  <div className="ui-input first-input">
                                      ...
                                      <div className="acb9vpv">
                                      <div>
                                              <input required className="ui-checkbox" type='checkbox'/>
                                          </div>
                                          <div className="label">
                                              <span>I agree to the </span>
                                              <a className="argument" href="#" target="_blank">User Agreement</a>
                                              <span> &amp; confirm I am at least 18 years old</span>
                                          </div>
                                      </div>
                                      <div className="acb9vpv">
                                          <div>
                              ...
                              <div className="other-sign-wrap">
                                  ...
                                  <div className="third-group-wrap">
                                      ...
                                      <button id="tg_login" type="button" title="telegram">
                                          <svg width="12" height="12" viewBox="0 0 10 9" xmlns="http://www.w3.org/2000/svg" className="tel icon">
                                      ...
                                      <button id="ln_login" type="button" title="line">
                                          <svg width="14" height="14" className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                                      ...
                                      <button id="st_login" type="button" title="steam">
                                          <svg width="12" height="12" className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                              <g clipPath={"url(#a)"}>
...
function SignUp() {
    ...
    return (
      <div>
        {!isLoggedIn && (<button onClick={handleShow} className="nav-action">Sign Up</button>)}
