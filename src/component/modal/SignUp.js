                      ...
                      <div class="ithbrou">
                          ...
                          <div id="regist" className="simple-page s15zywit" style={{ opacity: 1, transform: 'none' }}>
                                  ...
                                  <div class="ui-input first-input">
                                      ...
                                      <div>
                                          ...
                                          <div class="label">
                                              ...
                                              <a class="argument" href="#" target="_blank">User Agreement</a>
                                  ...
                                  <div class="have-account">
                                      ...
                                      <div class="r">Sign in</div>
                                  </div>
                              </div>
                              
                              <div class="other-sign-wrap">
                                  <div class="line-text">
                                      <div class="l"></div>
                                      <div class="t">Log in directly with</div>
                                      <div class="l"></div>
                                  </div>
                                  <div class="third-group-wrap">
                                      <button id="gg_login" type="button" title="google">
                                          <svg width="12" height="12" viewBox="0 0 10 11" xmlns="http://www.w3.org/2000/svg" class="icon">
                                      ...
                                      <button id="tg_login" type="button" title="telegram">
                                          <svg width="12" height="12" viewBox="0 0 10 9" xmlns="http://www.w3.org/2000/svg" class="tel icon">
                                      ...
                                      <button id="mm_login" type="button" title="metamask">
                                          <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" class="icon">
                                      ...
                                      <button id="wc_login" type="button" title="wallet connect">
                                          <svg width="16" height="16" viewBox="0 0 13 9" xmlns="http://www.w3.org/2000/svg" class="icon">
                                      ...
                                      <button id="wa_login" type="button" title="whatsapp">
                                          <svg width="12" height="12" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" class="icon">
                                      ...
                                      <button id="ln_login" type="button" title="line">
                                          <svg width="14" height="14" class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                                      ...
                                      <button id="st_login" type="button" title="steam">
                                          <svg width="12" height="12" class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                              <g clipPath={"url(#a)"}>
